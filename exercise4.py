...
print(f"Suma de los Numeros es: {suma_de_numeros}")
# COMPLETAR - FIN
...
print(f"La concatenacion de los numeros da: {suma_de_numeros_string}")
# COMPLETAR - FIN
...
print(f"La multiplicacion de los numeros da: {multiplicacion_de_numeros}")
# COMPLETAR - FIN
...
print(f"La resta de los numeros da: {resultado_resta}")
# COMPLETAR - FIN
